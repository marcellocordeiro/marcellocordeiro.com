...
<header class={["sticky top-0 z-10 px-4 pt-4", className]}>
  ...
  >
    <div class="min-h-header flex w-full items-center justify-between px-4">
      <Link href="/">
    ...
    <div
      class="hidden w-full px-4 pb-4 data-[expanded=true]:block"
      id="mobile-nav"
      data-expanded={expandMobileNav}
    >
      <ul class="flex flex-col rounded border bg-background/80 p-4 font-medium">
